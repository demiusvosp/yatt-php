...
class TaskFixture extends ActiveFixture
{
    ...
    public function load()
    {
        ...
        $versionsOpen  = $project->getVersions()->andForClose()->all();
        ...
        foreach ($this->getData() as $alias => $row) {
            ...
            $task->dict_difficulty_id = $project->categories[array_rand($project->difficulties)]->id;
            $task->dict_stage_id      = $project->categories[array_rand($project->stages)]->id;
            ...
            if (rand(0, 1)) {
                ...
                $task->dict_version_open_id = $versionsClose[array_rand($versionsOpen)]->id;
            }
