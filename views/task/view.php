...
$canClose = !$task->is_closed && Yii::$app->user->can(Permission::CLOSE_TASK);
?>
<div class="row-fluid">
    <div class="btn-group">
        <?php if(Yii::$app->user->can(Permission::EDIT_TASK)) { ?>
            <a
                class="btn btn-app"
        ...
        <?php if(Yii::$app->user->can(Permission::CHANGE_STAGE)) { ?>
            <div class="btn-group">
